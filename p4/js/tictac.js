...
$(function () {
    ...
    set = function () {
        ...
        if (win(score[turn])) {
        // Creates a new button instead of auto resetting
        var newGameButton = $("<button>").text("Congratulations " + turn + ", you win!! New Game?").appendTo("body").click(function() {
        startNewGame();
        ...
        newGameButton.hide();
            ...
            var newGameButton = $("<button>").text("Cat's Game! No winner?! Try Again?").appendTo("body").click(function() {
                startNewGame();
                // Hide the button after clicking
                newGameButton.hide();
            });
